      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3">
            ...
            <a href="https://www.instagram.com/geeksforgeeks.pdeu/" className="text-white hover:text-[#f1f3f4]">
              ...
              <a href="https://www.linkedin.com/company/geeksforgeekspdeu/posts/?feedView=all" className="text-white hover:text-[#f1f3f4]">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
